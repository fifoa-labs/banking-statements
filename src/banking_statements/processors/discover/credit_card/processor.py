"""
src/banking_statements/processors/discover/credit_card/processor.py

Statement processor for Discover credit-card statements.
"""
...
class DiscoverCreditCardProcessor:
    """Processor for supported Discover credit-card statements."""

    @property
    def name(self) -> str:
        """Return the stable processor identifier."""
        return "discover.credit_card.v1"
    ...
    def match(self, text: StatementText) -> ProcessorMatch:
        ...
        matched = any(
            ...
            for signature in DISCOVER_CREDIT_CARD_SIGNATURES
        )
        ...
        return ProcessorMatch(
            ...
            reason=(
                ...
                if matched
                else "Required Discover credit-card markers were not found."
            ),
        )
    ...
    def parse(
        ...
        """Parse a Discover credit-card statement."""
