"""
src/banking_statements/processors/capital_one/credit_card/summary.py

Balance-summary parsing for supported Capital One credit-card statements.
"""
...
def _parse_amount(value: str) -> Decimal:
    """Parse one Capital One credit-card balance amount."""
...
def _parse_required_balance(
    ...
    *,
    ...
    """Parse one required Capital One credit-card balance field."""
    match = pattern.search(text)

    if match is None:
        msg = f"Capital One credit-card summary field {field!r} was not found."
...
def parse_balance_summary(text: StatementText) -> StatementBalanceSummary:
    """Parse reported Capital One credit-card opening and closing balances."""
