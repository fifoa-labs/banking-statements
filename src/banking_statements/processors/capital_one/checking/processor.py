"""
src/banking_statements/processors/capital_one/checking/processor.py

Statement processor for supported Capital One 360 checking statements.
"""
...
class CapitalOneCheckingProcessor:
    """Processor for supported Capital One 360 checking statements."""

    @property
    def name(self) -> str:
        """Return the stable processor identifier."""
        return "capital_one.checking.v1"
    ...
    def match(self, text: StatementText) -> ProcessorMatch:
        ...
        matched = any(
            ...
            for signature in CAPITAL_ONE_CHECKING_SIGNATURES
        )
        ...
        return ProcessorMatch(
            ...
            reason=(
                ...
                if matched
                else "Required Capital One checking markers were not found."
            ),
        )
    ...
    def parse(
        ...
        """Parse a Capital One 360 checking statement."""
