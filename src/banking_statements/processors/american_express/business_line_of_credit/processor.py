"""
src/banking_statements/processors/american_express/business_line_of_credit/processor.py

Statement processor for American Express business line-of-credit statements.
"""
...
class AmericanExpressBusinessLineOfCreditProcessor:
    """Processor for American Express business line-of-credit statements."""

    @property
    def name(self) -> str:
        """Return the stable processor identifier."""
        return "american_express.business_line_of_credit.v1"
    ...
    def match(self, text: StatementText) -> ProcessorMatch:
        ...
        matched = any(
            ...
            for signature in AMERICAN_EXPRESS_BUSINESS_LINE_OF_CREDIT_SIGNATURES  # noqa: E501
        )
        ...
        return ProcessorMatch(
            ...
            reason=(
                "Matched American Express business line-of-credit statement "
                "structure."
                if matched
                else (
                    "Required American Express business line-of-credit "
    ...
    def parse(
        ...
        """Parse an American Express business line-of-credit statement."""
