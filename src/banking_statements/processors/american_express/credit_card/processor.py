"""
src/banking_statements/processors/american_express/credit_card/processor.py

Statement processor for supported American Express credit-card statements.
"""
...
class AmericanExpressCreditCardProcessor:
    """Processor for supported American Express credit-card statements."""

    @property
    def name(self) -> str:
        """Return the stable processor identifier."""
        return "american_express.credit_card.v1"
    ...
    def match(self, text: StatementText) -> ProcessorMatch:
        ...
        matched = any(
            ...
            for signature in AMERICAN_EXPRESS_CREDIT_CARD_SIGNATURES
        )
        ...
        return ProcessorMatch(
            ...
            reason=(
                ...
                if matched
                    ...
                    "Required American Express credit-card markers were not "
                    "found."
                )
            ),
        )
    ...
    def parse(
        ...
        """Parse an American Express credit-card statement."""
