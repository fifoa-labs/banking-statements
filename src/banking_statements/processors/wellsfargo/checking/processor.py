"""
src/banking_statements/processors/wellsfargo/checking/processor.py

Statement processor for the first supported Wells Fargo checking format.
"""
...
class WellsFargoCheckingProcessor:
    """Processor for the first supported Wells Fargo checking format."""

    @property
    def name(self) -> str:
        """Return the stable processor identifier."""
        return "wellsfargo.checking.v1"
    ...
    def match(self, text: StatementText) -> ProcessorMatch:
        ...
        matched = any(
            ...
            for signature in WELLS_FARGO_CHECKING_SIGNATURES
        )
        ...
        return ProcessorMatch(
            ...
            reason=(
                "Matched Wells Fargo checking statement structure."
                if matched
                else "Required Wells Fargo checking markers were not found."
            ),
        )
    ...
    def parse(
        ...
        """Parse a Wells Fargo checking statement."""
