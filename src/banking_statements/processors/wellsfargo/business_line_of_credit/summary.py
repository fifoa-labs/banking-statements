"""
src/banking_statements/processors/wellsfargo/business_line_of_credit/summary.py

Balance-summary parsing for Wells Fargo business line-of-credit statements.
"""
...
def _parse_summary_amount(
    ...
    """Parse one required business line-of-credit summary amount."""
    match = _SUMMARY_PATTERNS[field].search(text)

    if match is None:
        msg = (
            "Wells Fargo business line-of-credit summary field "
...
def parse_balance_summary(
    ...
    """Parse Wells Fargo business line-of-credit balance checkpoints."""
