"""
src/banking_statements/processors/wellsfargo/business_line_of_credit/processor.py

Statement processor for supported Wells Fargo
...
class WellsFargoBusinessLineOfCreditProcessor:
    """Processor for supported Wells Fargo
    business line-of-credit statements.
    """
    ...
    def name(self) -> str:
        ...
        return "wellsfargo.business_line_of_credit.v1"
    ...
    def match(self, text: StatementText) -> ProcessorMatch:
        ...
        matched = any(
            ...
            for signature in WELLS_FARGO_BUSINESS_LINE_OF_CREDIT_SIGNATURES
        )
        ...
        return ProcessorMatch(
            ...
            reason=(
                "Matched Wells Fargo business line-of-credit statement structure."  # noqa: E501
                if matched
                else (
                    "Required Wells Fargo business line-of-credit markers "
                    "were not found."
                )
            ),
        )
    ...
    def parse(
        ...
        """Parse a Wells Fargo business line-of-credit statement."""
